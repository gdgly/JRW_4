...
void SPI_init(void)
{    
	GPIO_SetMode(P0, BIT4, GPIO_PMD_OUTPUT);	//CSN PIN output High pulling push
	P04 = 1;
	GPIO_SetMode(P0, BIT7, GPIO_PMD_OUTPUT);	//SCK PIN output Low  pulling push 
	P07 = 0;
	GPIO_SetMode(P0, BIT6, GPIO_PMD_OUTPUT);  //DATA PIN output  DEFAULT  High pulling push
	P06 = 0;             
}
